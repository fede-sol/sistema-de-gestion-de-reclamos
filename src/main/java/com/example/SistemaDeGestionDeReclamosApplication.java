...
public class SistemaDeGestionDeReclamosApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		 ...
		 * }
		 * 
		 * controlador.agregarPersona("99999999", "konstantinos", "konstagmail.com",
		 * "contraK");
		 * 
...
// ANOTACIONES
/*
 * tenemos metodos para buscar personas por el nombre "getPersona" y por el
 * documento "buscarPersona"
 * estos metodos deverian seguir la misma comvencion y denotar bajo que criterio
 * se realiza la busqueda
 * buscarPersona es private y getPersona no, no deverian ser las dos public?
 * 
 * reclamos por unidad, deveria tomar como parametro la misma unidad,
 * actualmente esta tomando su edificio, piso y numero
 * 
 * public Persona getPersona(String nombre) en controlador, no habria q pasar
 * esto al repository?
 */